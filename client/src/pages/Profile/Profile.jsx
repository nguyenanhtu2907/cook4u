        ...
        <div className="profile-page">
            ...
            <div className="profile-page--paper ">
                <div className="profile-page--paper--info shadow">
                    ...
                    {JSON.parse(localStorage.getItem('profile'))?.token.length < 500 && currentUser.uuid === targetUser.uuid && (
                        <>
                            ...
                            {currentUser.level === 'admin' && (
                                <div className="profile-page--paper--info__setting pointer report-icon" >
                                    <Link to='admin' ><ReportRoundedIcon fontSize='large' /></Link>
                                </div>
                            )}
                    ...
                    <div className="profile-page--paper--info--more">
                        <div className="profile-page--paper--info--more__item pointer" onClick={() => {
                        ...
                        <>
                            ...
                            <div className="profile-page--paper--content--posts__head" style={{ paddingTop: '1rem' }}>
                                <Button onClick={() => {
                                    setOpenList('');
                                    setFollowList([]);
                                }}><ArrowBackIosIcon fontSize="small" /> Trở lại</Button>
                            </div>
                            <div className="profile-page--paper--content--posts__head end-block">
                                <h5>{`${openList === 'followed' ? `${targetUser.followed.length} người đã theo dõi ${targetUser.name}` : `${targetUser.name} đang theo dõi ${targetUser.following.length} người`}`}</h5>
                            </div>
                            {followList.map(user => (
                                <Link to={`/user/${user.uuid}`} className="big-card--content__author pd-left-3 pd-right-3 end-block list-user-item">
                                    <div className="big-card--content__author__image">
                                        <img referrerPolicy='no-referrer' width='50' height='50' src={user.imageUrl} alt="" />
                                    </div>
                            ...
                            {openList === 'followed' ? (
                                <div className={`profile-page--paper--content--pagi end-block ${targetUser.followed.length <= 20 && 'dp-none'}`}>
                                    <ReactPaginate
                                ...
                                <div className={`profile-page--paper--content--pagi end-block ${targetUser.following.length <= 20 && 'dp-none'}`}>
                                    <ReactPaginate
