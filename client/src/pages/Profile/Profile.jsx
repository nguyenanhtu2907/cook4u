...
function Profile(props) {
  ...
  const fetchFollowUsers = async (type, { selected }) => {
    const { data } = await api.getFollowUsersApi(
      targetUser.uuid,
      type,
      selected || 0
    );
        ...
        <div className="profile-page--paper--info shadow">
          ...
          <div className="profile-page--paper--info--text">
            ...
            <div
              ...
              className="profile-page--paper--info--text__follow-btn"
            >
        ...
        <div className="profile-page--paper--content pd-left-3 pd-right-3 shadow">
          {openList ? (
            <>
              ...
              <div
                className="profile-page--paper--content--posts__head"
                ...
                >
                  <ReactPaginate
                    ...
                    onPageChange={(selected) =>
                      fetchFollowUsers(openList, selected)
                    }
                    initialPage={0}
            ...
            <>
              ...
              {isOwn ? (
                <>
                  {notFoundOwn ? (
                    <h3 className="pd-left-3 pd-right-3">
                ...
                <>
                  ...
                  >
                    <ReactPaginate
                      ...
                      nextLabel={"Tiếp theo"}
                      onPageChange={(selected) =>
                        handlePageChangeLikedPosts(selected)
                      }
                      initialPage={0}
                      activeLinkClassName="click-page"
                      disableInitialCallback={true}
