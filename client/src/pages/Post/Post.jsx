...
function Post() {
  ...
  const following = currentUser?.following.findIndex(
    (userId) => userId === post?.author.uuid
  );
      ...
      <div className="post-page--paper shadow">
                ...
                >
                  ...
                  <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                      Thao tác của bạn sẽ xóa vĩnh viễn bài viết và không thể
                      khôi phục. Bạn chắc chắn chứ?
                    </DialogContentText>
                  </DialogContent>
                  <DialogActions>
                    <Button
                      onClick={handleCickAgreeDelete}
                      color="primary"
                      autoFocus
                    >
                      Xóa ngay
        ...
        <div className="post-page--paper--intro pd-left-3 end-block">
          ...
          <div className="post-page--paper--intro--post-author">
            <Link
              to={`/user/${post.author.uuid}`}
              className="post-page--paper--intro--post-author__info"
            >
            ...
            <div
              ...
              className="post-page--paper--intro--post-author__button"
            >
          ...
          <ul className="post-page--paper--ingredients__list">
            {post.ingredients.map((ingredient, index) => (
              <li
                ...
                className={
                  index !== 0
                    ? "post-page--paper--ingredients__list__end-item"
                    : null
                }
              >
                {ingredient.text}
        ...
        <div className="post-page--paper--comment pd-left-3 end-block">
          ...
          <div className="post-page--paper--comment--content">
            ...
            <form
              ...
              className="post-page--paper--comment--content__form"
            >
