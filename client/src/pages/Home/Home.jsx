            ...
            <div className="home-page--paper">
                {width > 768 && (
                    <div className="home-page--paper--intro">
                        ...
                        <Link to='/post/create' className="home-page--paper--intro--new-post">
                            <Button color='inherit' ><AddRoundedIcon /> Thêm món mới</Button>
                        </Link>
                    </div>
                )}
                <div>
                    <div onClick={() => setIsSuggest(true)} className={`home-page--paper--switch pointer ${isSuggest && "home-page--paper--focus"}`}>
                        Khám phá
                    </div>
                    <div onClick={() => setIsSuggest(false)} className={`home-page--paper--switch pointer ${!isSuggest && "home-page--paper--focus"}`}>
                        Đang theo dõi
                    </div>
                </div>
