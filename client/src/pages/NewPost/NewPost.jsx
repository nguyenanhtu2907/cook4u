  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      steps: Yup.array().required(
        "Bạn vui lòng nhập các bước tạo thành món ăn."
      ),
    }),
    onSubmit: slug
      ? async (values) => {
          ...
          values.steps = values.steps.filter(
            (step) => step.text || step.images.length !== 0
          );
  ...
  return (
    <form onSubmit={formik.handleSubmit} className="new-post-page">
      <div className="new-post-page--paper shadow">
        <label
          htmlFor="thumbnail"
          className="new-post-page--paper--thumbnail pointer"
        >
          {formik.values.thumbnail ? (
            ...
            <div>
              <img
                src={camera}
                alt=""
                className="new-post-page--paper--thumbnail__default pointer"
              />
          ...
          <input
            ...
            onChange={(e) => {
              convertImageToBase64(e.target.files[0], (result) => {
                result &&
                  formik.setValues({ ...formik.values, thumbnail: result });
              });
            }}
          />
        </label>
        ...
        <div className="new-post-page--paper--ingredients pd-left-3 pd-right-3 end-block">
          ...
          {formik.values.ingredients.map((ingredient, index) => (
            <div key={index}>
              <div className="new-post-page--paper--ingredients--input">
                ...
                <div>
                  <IconButton
                    onClick={() => handleDeleteIngre(ingredient.id)}
                    size="small"
                  >
          ...
          <div
            ...
            className="new-post-page--paper--ingredients--add"
          >
            <Button>
              <AddIcon /> Nguyên liệu
            </Button>
        ...
        <div className="new-post-page--paper--steps pd-left-3 pd-right-3 end-block">
          ...
          <div
            ...
            className="new-post-page--paper--steps--add"
          >
            <Button>
              <AddIcon /> Bước
            </Button>
