...
export const getFollowUsersApi = (uuid, type, skip) => API.get(`/user/${uuid}/follow?type=${type}&skip=${skip}`)
...
export const reportApi = (report) => API.post('/user/report', report);
export const getReportsApi = () => API.get('/user/report');
export const removeReportApi = (uuid) => API.delete(`/user/report/${uuid}`);
//quite complex
